...
class IndicatorService
{
    protected $indicatorMap = [
        'Number of supported actors profitability engaged in commercialization of RTC'                                             => [
            'RTC MARKET' => 'indicators.rtc-market.indicator-a1',
        ],
        'Number of unique individividuals reached with RTC value chain Interventions'                                              => [
            'RTC MARKET' => 'indicators.rtc-market.indicator-a1b',
        ],
        'Increase in revenue ($ value) for supported RTC actors'                                                                   => [
