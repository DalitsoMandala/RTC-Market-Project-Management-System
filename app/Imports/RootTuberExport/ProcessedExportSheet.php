...
class ProcessedExportSheet implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure, WithStartRow
{
    ...
    public function model(array $row)
    {
        ...
        $data = ProcessedTuberExport::create([
    ...
    public function onFailure(Failure ...$failures)
    {
        ...
        foreach ($failures as $failure) {
            $errorMessage = "Validation Error on sheet 'PROCESSED PRODUCTS EXPORTS SHEET' - Row {$failure->row()}, Field '{$failure->attribute()}': " .
