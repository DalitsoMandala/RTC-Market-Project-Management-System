...
class RootTuberImportTemplate implements WithMultipleSheets, WithChunkReading, WithEvents, ShouldQueue, WithBatchInserts
{
    use FormEssentials;
    ...
    public function __construct($cacheKey, $filePath, $submissionDetails)
    {
        ...
        foreach ($this->expectedSheetNames as $sheetName) {
            $this->expectedHeaders[$sheetName] = array_keys($this->forms['Root and Tuber Imports Form'][$sheetName]);
        }
    }
    ...
    {
        return [
            'ROOTS & TUBER RAW IMPORTS' => new RawImportSheet($this->submissionDetails, $this->cacheKey, $this->totalRows),
            'ROOTS & TUBER PROCESSED IMPORTS' => new ProcessedImportSheet($this->submissionDetails, $this->cacheKey, $this->totalRows),
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            BeforeImport::class => function (BeforeImport $event) {
                ...
                JobProgress::updateOrCreate(
                    ...
                    [
                        ...
                        'form_name' => 'Root Tuber Imports Form Import',
                    ]
                );
            ...
            ImportFailed::class => function (ImportFailed $event) {
                ...
                RawTuberImport::where('uuid', $this->cacheKey)->delete();
                ProcessedTuberImport::where('uuid', $this->cacheKey)->delete();
