...
class RawImportSheet implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure, WithStartRow
{
    ...
    public function onFailure(Failure ...$failures)
    {
        ...
        foreach ($failures as $failure) {
            $errorMessage = "Validation Error on sheet 'RAW PRODUCTS IMPORTS SHEET' - Row {$failure->row()}, Field '{$failure->attribute()}': " .
