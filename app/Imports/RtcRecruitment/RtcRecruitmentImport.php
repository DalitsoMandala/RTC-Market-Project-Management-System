...
class RtcRecruitmentImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure, WithStartRow
{
    ...
    public function model(array $row)
    {
        ...
        $farmerRecord = Recruitment::create([
            ...
            'is_profitably_engaged'       => $row['Is Profitably Engaged'] ?? 0,
            ...
            'profit_female_18_35'         => $row['Profitably Engaged Female 18-35'] ?? 0,
            'profit_male_18_35'           => $row['Profitably Engaged Male 18-35'] ?? 0,
            'profit_male_35_plus'         => $row['Profitably Engaged Male 35+'] ?? 0,
            'profit_female_35_plus'       => $row['Profitably Engaged Female 35+'] ?? 0,
    ...
    public function rules(): array
    {
        return [
            ...
            'Profitably Engaged Female 18-35' => 'nullable|numeric|min:0',
            'Profitably Engaged Male 18-35'   => 'nullable|numeric|min:0',
            'Profitably Engaged Male 35+'     => 'nullable|numeric|min:0',
            'Profitably Engaged Female 35+'   => 'nullable|numeric|min:0',
