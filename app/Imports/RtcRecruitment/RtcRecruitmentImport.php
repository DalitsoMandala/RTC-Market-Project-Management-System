...
class RtcRecruitmentImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure, WithStartRow
{
    ...
    public function rules(): array
    {
        return [
            ...
            'Members Female 18-35' => 'required|integer|min:0',
            'Members Male 18-35' => 'rquired|integer|min:0',
            'Members Male 35+' => 'rquired|integer|min:0',
            'Members Female 35+' => 'rquired|integer|min:0',
            ...
            'Employees Formal Female 18-35' => 'rquired|integer|min:0',
            'Employees Formal Male 18-35' => 'rquired|integer|min:0',
            'Employees Formal Male 35+' => 'rquired|integer|min:0',
            'Employees Formal Female 35+' => 'rquired|integer|min:0',
            'Employees Informal Female 18-35' => 'rquired|integer|min:0',
            'Employees Informal Male 18-35' => 'rquired|integer|min:0',
            'Employees Informal Male 35+' => 'rquired|integer|min:0',
            'Employees Informal Female 35+' => 'rquired|integer|min:0',
