...
class RtcProductionFarmersImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure, WithStartRow
{
    ...
    public function rules(): array
    {
        return [
            ...
            'Number of Plantlets Produced Cassava' => 'required|integer|min:0',
            'Number of Plantlets Produced Potato' => 'required|integer|min:0',
            'Number of Plantlets Produced Sweet Potato' => 'required|integer|min:0',
            'Screen House Vines Harvested' => 'required|integer|min:0',
            'Screen House Min Tubers Harvested' => 'required|integer|min:0',
            'SAH Plants Produced' => 'required|integer|min:0',
