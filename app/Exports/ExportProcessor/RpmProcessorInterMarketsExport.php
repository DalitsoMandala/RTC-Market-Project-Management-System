...
class RpmProcessorInterMarketsExport implements FromCollection, WithHeadings, WithTitle, WithMapping, WithStrictNullComparison, ShouldAutoSize, WithEvents
{
    ...
    public function __construct($template)
    {
        ...
        $this->validationTypes = $this->forms['Rtc Production Processors Form']['International Markets'];
    }
