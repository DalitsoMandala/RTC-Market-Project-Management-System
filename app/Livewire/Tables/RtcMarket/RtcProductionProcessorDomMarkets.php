...
final class RtcProductionProcessorDomMarkets extends PowerGridComponent
{
    ...
    public function datasource(): Builder
    {
        ...
        $query = RpmProcessorDomMarket::query()->with('processors')->select([
            'rpm_processor_dom_markets.*',
  ...
  public function relationSearch(): array
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Processor ID', 'unique_id')->bodyAttribute('table-sticky-col')
                ->headerAttribute('table-sticky-col')->searchable(),
