<div class="row align-items-center">
    ...
    <div class="col-12 col-sm-6">
        <div class=" d-flex justify-content-end align-items-center">
            ...
            <button type="button" wire:loading.attr='disabled' wire:click='startExport()' wire:target='startExport, startProgressExport'
            ...
            <button type="button" wire:loading.attr='disabled' wire:click='startProgressExport()' wire:target='startExport, startProgressExport'
                @if ($this->exporting && !$this->exportFinished) disabled @endif
                class="btn ms-1 btn-warning btn-label waves-effect waves-light"><i
                    class="align-middle bx bx-export label-icon fs-16 me-2"></i>
                @if ($this->exporting && !$this->exportFinished)
                    <span wire:poll.5s="exportProgress">Exporting...please wait!</span>
                @else
