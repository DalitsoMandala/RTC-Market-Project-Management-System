            ...
            <div class="col-12 col-md-12 ">
                ...
                <div class="row gy-3 justify-content-center" x-data="dashboard">
                    ...
                    <div class="text-center  col-md-12 col-12">
                        ...
                        <div class="card">
                            <div class="card-header card-title fw-bold border-bottom-0">
                                <h5 class="card-title">Processes/Stages in the value chain</h5>


                            </div>

                            <div class="card-body">
                                <div id="stages" x-show='!hasZeroValues(stagesChart)'></div>
                                <x-no-data x-show='hasZeroValues(stagesChart)' />
                            </div>
                        </div>
                    </div>
    ...
    <script>
        Alpine.data('dashboard', () => ({
            ...
            setData(data) {
                ...
                this.stagesChart = [
                    data['Seed production'],
                    data['Storage'],
                    data['Agronomic production'],
                    data['Post-harvest processing']
            ...
            init() {
                ...
                const stages = new ApexCharts(document.querySelector("#stages"), {
                    chart: {
                        height: 338,
                        type: 'bar', // Main chart type
                        toolbar: {
                    ...
                    series: [{
                            name: 'Value',
                            type: 'bar', // Bar series
                            data: this.stagesChart, // Raw numeric values for the bar
                        },
                    ...
                    labels: ['Seed production', 'Storage', 'Agronomic production',
                        'Post-harvest processing'
                    ],
                    colors: ['#FC931D', '#FA7070', '#DE8F5F', '#EC6347'], // Bar and line colors
                    xaxis: {
                        categories: ['Seed production', 'Storage', 'Agronomic production',
                            'Post-harvest processing'
                        ],
