            ...
            <div class="col-12 col-md-12 ">
                ...
                <div class="row gy-3 justify-content-center" x-data="dashboard">
                    ...
                    <div class="text-center col-md-6 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Individual Training Distribution</h5>
    ...
    <script>
        Alpine.data('dashboard', () => ({
            ...
            setData(data) {
                ...
                this.professionChart = [data.Farmers, data.Processors, data.Traders, data.Partner, data.Staff];
            ...
            init() {
                ...
                const professionChartInstance = new ApexCharts(document.querySelector("#professionChart"), {
                    ...
                    xaxis: {
                        categories: ['Farmers', 'Processors', 'Traders', 'Partner', 'Staff'],
