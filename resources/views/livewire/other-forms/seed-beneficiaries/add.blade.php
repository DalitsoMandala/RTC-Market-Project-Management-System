        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Add Seed Beneficiaries</h4>

                    <div class="page-title-right">
                        <ol class="m-0 breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add Seed Beneficiaries</li>
                        </ol>
                    </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <ul class="nav nav-tabs" id="beneficiaryTabs" role="tablist" wire:ignore>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="manual-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">Add Manually</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="batch-tab" data-bs-toggle="tab" data-bs-target="#batch"
                                type="button" role="tab" aria-controls="batch" aria-selected="false">Upload
                                Batch</button>
                        </li>
                    </ul>
                ...
                <div class="card-body">
                    ...
                    <!-- Tab Content -->
                    <div class="mt-3 tab-content" id="beneficiaryTabsContent">
                        <!-- Manual Entry Form -->
                        ...
                        @include('livewire.other-forms.seed-beneficiaries.upload')
