<x-form-component :showAlpineAlerts="true" title="Add Seed Beneficiaries Data" pageTitle="Add Data" :formTitle="$form_name"
    ...
    <div class="mb-3">
        ...
        <div>
            <div class="form-check form-check-inline">
                <input class="form-check-input @error('crop') is-invalid @enderror" type="radio" id="crop_potato"
                    wire:model.live="crop" value="Potato">
                <label class="form-check-label" for="crop_potato">Potato</label>
            </div>

            <div class="form-check form-check-inline">
                <input class="form-check-input @error('crop') is-invalid @enderror" type="radio" id="crop_ofsp"
                    wire:model.live="crop" value="Sweet potato">
                <label class="form-check-label " for="crop_ofsp">Sweet potato</label>
            </div>

            <div class="form-check form-check-inline">
                <input class="form-check-input @error('crop') is-invalid @enderror" type="radio" id="crop_cassava"
                    wire:model.live="crop" value="Cassava">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('group_name') is-invalid @enderror" wire:model="group_name">
        @error('group_name')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control @error('age') is-invalid @enderror" wire:model="age" min="1">
        @error('age')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <select class="form-select @error('selectedVarieties') is-invalid @enderror" wire:model.live="selectedVarieties"
            multiple>
    ...
    <!-- Bundles Received -->
    <div class="mb-3">
        <label class="form-label">Amount Of Seed Received (@if ($crop === 'Potato')
                KG
            @else
                Bundles
            @endif)</label>
