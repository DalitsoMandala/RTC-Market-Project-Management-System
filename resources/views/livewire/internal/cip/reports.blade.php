    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class=" nav nav-tabs nav-border-top nav-border-top-primary">
                    <li class="nav-item">
                        <a href="#" class="nav-link active disabled" aria-current="page">REPORTS
                        </a>
                    </li>
                ...
                <div class="card ">
                    ...
                    <div class=" card-body">
                                ...
                                <div class=" row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            is-invalid
                                        @enderror"
                                                wire:model.live.debounce.600ms="selectedCrop"
                                                wire:loading.attr='disabled' wire:loading.class='opacity-25'
                                                wire:target='selectedOrganisation, selectedIndicator, selectedDisaggregation,selectedCrop'>
                                    ...
                                    @hasanyrole('admin|manager')
                                        <div class="col">
                                            <div class="mb-1 d-flex justify-content-end">
                                                <div class="text-end">
                                                    <button type="button" class="btn btn-secondary " wire:click='load'
                        ...
                        <div class="my-2" x-data="{ show: $wire.entangle('loadingData') }" :class="{ 'pe-none opacity-25': show === true }">
