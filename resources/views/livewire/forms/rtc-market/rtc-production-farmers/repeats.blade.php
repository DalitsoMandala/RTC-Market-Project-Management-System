                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select
                                class="form-select @error('inputOne.' . $index . '.conc_country') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select
                                class="form-select @error('inputOne.' . $index . '.conc_product_type') is-invalid @enderror"
...
<div x-data="{
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select
                                class="form-select @error('inputTwo.' . $index . '.dom_crop_type') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">PRODUCT TYPE</label>
                            <select
                                class="form-select @error('inputTwo.' . $index . '.dom_product_type') is-invalid @enderror"
    ...
    <div class="pb-4 text-center">
        <button type="button" wire:loading.attr="disabled" class="px-4 btn btn-light btn-sm"
            @click='$wire.addInputTwo()'>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label fw-bold">CROP TYPE</label>
                            <select
                                class="form-select @error('inputThree.' . $index . '.inter_crop_type') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">COUNTRY</label>
                            <select
                                class="form-select @error('inputThree.' . $index . '.inter_country') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">PRODUCT TYPE</label>
                            <select
                                class="form-select @error('inputThree.' . $index . '.inter_product_type') is-invalid @enderror"
