<x-form-component :showAlpineAlerts="true" title="Add Rtc Consumption Data" pageTitle="Add Data" :formTitle="$form_name"
 ...
 :bypassTargets="true"
    ...
    <div x-data="{
        ...
        enterprise: null,
        entity_name: $wire.entangle('location_data.entity_name'),
        entity_type: $wire.entangle('location_data.entity_type'),
        district: $wire.entangle('location_data.district'),
        epa: $wire.entangle('location_data.epa'),
        section: $wire.entangle('location_data.section'),
        showHousehold: false,
        init() {
        ...
        <div class="mb-3">
            ...
            <div class="list-group  @error('crop')border border-danger @enderror">
                <label class="mb-0 list-group-item text-capitalize">
                    <input class="form-check-input me-1" type="checkbox" wire:model='crop.cassava' value="cassava" />
                    Cassava
                </label>
                <label class="mb-0 list-group-item text-capitalize">
                    <input class="form-check-input me-1" type="checkbox" wire:model='crop.potato' value="potato" />
                    Potato
                </label>
                <label class="mb-0 list-group-item text-capitalize">
                    <input class="form-check-input me-1" wire:model='crop.sweet_potato' type="checkbox" value="sweet_potato" />
                    Sweet potato
                </label>
