    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                ...
                <h3 class="mb-5 text-center text-warning">RTC CONSUMPTION</h3>
                ...
                <div
                    ...
                    <h5> Instructions</h5>
                    <p class="alert bg-secondary-subtle text-uppercase">Download the Rtc Consumption template &
                        upload your
                        data.</p>
