...
<x-form-component :showAlpineAlerts="true" title="Add Recruitment Data" pageTitle="Add Data" :formTitle="$form_name" :openSubmission="$openSubmission"
    ...
    number_of_members.total = parseInt(number_of_members.female_18_35 || 0) +
        parseInt(number_of_members.female_35_plus || 0) +
        parseInt(number_of_members.male_18_35 || 0) +
        parseInt(number_of_members.male_35_plus || 0);">
    ...
    number_of_employees.formal.total = parseInt(number_of_employees.formal.female_18_35 || 0) +
        parseInt(number_of_employees.formal.female_35_plus || 0) +
        parseInt(number_of_employees.formal.male_18_35 || 0) +
        parseInt(number_of_employees.formal.male_35_plus || 0);
    
    number_of_employees.informal.total = parseInt(number_of_employees.informal.female_18_35 || 0) +
        parseInt(number_of_employees.informal.female_35_plus || 0) +
        parseInt(number_of_employees.informal.male_18_35 || 0) +
        parseInt(number_of_employees.informal.male_35_plus || 0);">
                    ...
                    <tr>
                        ...
                        <td>
                            <button wire:click.debounce.1000ms="removeRegistration({{ $index }})"
                                @if (count($registrations) <= 1) disabled @endif class="btn btn-danger btn-sm"><i
