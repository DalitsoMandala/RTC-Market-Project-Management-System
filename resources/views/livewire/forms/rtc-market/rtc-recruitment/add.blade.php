                            ...
                            <div class="card col-12 col-md-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            class="form-control @error('date_of_recruitment') is-invalid @enderror"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('name_of_actor') is-invalid @enderror"
                                            id="nameOfActor" wire:model='name_of_actor'>
                                        @error('name_of_actor')
                                            <x-error>{{ $message }}</x-error>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('name_of_representative') is-invalid @enderror"
                                    ...
                                    <div class="mb-3" x-data="{ type: $wire.entangle('group'), approach: $wire.entangle('approach') }" x-init="$watch('type', (v) => {
                                        ...
                                        <label for="approach" class="form-label">What Approach Does Your Group Follow
                                            (For Producer Organizations
                                            Only)</label>
                                        <select class="form-select @error('approach') is-invalid @enderror"
                                            wire:model="approach">
                                            <option value="">Select One</option>
                                    ...
                                    <div x-show="type==='Farmers'" class="mb-3" x-data="{
                                        ...
                                        <select class="form-select @error('category') is-invalid @enderror"
                                            id="establishment" x-model='category'>
                                            <option value="">Select One</option>
                                    ...
                                    <div class="mb-3">
                                        <label for="establishment" class="form-label">Is this a New or Old
                                            Establishment</label>
                                        <select
                                            class="form-select @error('establishment_status') is-invalid @enderror"
                                            id="establishment" wire:model='establishment_status'>
                                            <option value="">Select One</option>
                                    ...
                                    <div class="mb-3" x-data="{ is_registered: $wire.entangle('is_registered') }">
                                        ...
                                        @enderror">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('is_registered') is-invalid @enderror"
                                                    type="radio" id="registeredNo" value="0"
                                                    x-model="is_registered">
                                    ...
                                    <div class="mb-3" x-data="{
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                id="registrationBody"
                                                x-model="registration_details.registration_body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                x-model="registration_details.registration_number">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                id="registrationDate"
                                                x-model="registration_details.registration_date">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="formalFemale1835"
                                                        x-model="number_of_employees.formal.female_18_35">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="formalFemale35"
                                                        x-model="number_of_employees.formal.female_35_plus">
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="formalMale1835"
                                                        x-model="number_of_employees.formal.male_18_35">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="formalMale35"
                                                        x-model="number_of_employees.formal.male_35_plus">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        readonly id="formalFemale1835"
                                                        x-model="number_of_employees.formal.total">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="informalFemale1835"
                                                        x-model="number_of_employees.informal.female_18_35">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="informalFemale35"
                                                        x-model="number_of_employees.informal.female_35_plus">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="informalMale1835"
                                                        x-model="number_of_employees.informal.male_18_35">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        id="informalMale35"
                                                        x-model="number_of_employees.informal.male_35_plus">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" step="any"
                                                        ...
                                                        readonly id="formalFemale1835"
                                                        x-model="number_of_employees.informal.total">
                                    ...
                                    <div x-show="type==='Farmers'" class="mb-3" x-data="{
                                        ...
                                        <div
                                            class="@error('is_registered_seed_producer') border border-danger @enderror">
                                            <div class="form-check">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    x-model="is_registered_seed_producer">
                                                <label class="form-check-label"
                                                    for="registeredSeedProducerNo">No</label>
                                            </div>
                                        </div>
