                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select"
                                                ...
                                                <option value="" selected>Select Actor Type</option>
                                                <option value="FARMER">Farmer</option>
                                                <option value="PROCESSOR">Processor</option>
                                                <option value="TRADER">Trader</option>
                                                <option value="INDIVIDUALS FROM NUTRITION INTERVENTION">Individuals from
                                                    Nutrition
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select"
                                                ...
                                                <option value="" selected>Select RTC Group/Platform
                                                </option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" wire:model="inputs.{{ $key }}.sex">
                                        ...
                                        <div class="mb-3">
                                            <label for="rtcConsumptionFrequency" class="form-label">Frequency of RTC
                                                and
                                                Derived
                                                Products
