        ...
        <div class="row justify-content-center">
            <div class="col-8">
                ...
                <div class="mb-1 row justify-content-center @if ($openSubmission === false) opacity-25  pe-none @endif"
                                    ...
                                    @foreach ($inputs as $key => $value)
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="mainFood" class="form-label">Which of These RTC and
                                                        Their
                                                        Derived
                                                        Products
                                                        Do You Use
                    ...
                    <div x-data="{ checkifAggregate: $wire.entangle('checkifAggregate').live }" x-show="checkifAggregate === true">

                        <form x-data="{
                            data: {}, // Object to store form data with name as keys
                            loadAggregate: $wire.entangle('loadAggregate'),
                            sendData() {
                                // Validate before sending data
                                if (this.validateForm()) {
                                    $wire.dispatch('added-aggregates', { data: this.data });
                                }
                            },
                            updateData(name, value) {
                                // Only update data if value is numeric
                            ...
                            validateForm() {
                                ...
                                let isValid = true;
                                this.loadAggregate.forEach(name => {
                                    if (!this.data[name]) {
                                        this.errors[name] = `${name} field is required.`;
                                        isValid = false;
                                    } else if (!this.isNumeric(this.data[name])) {
                                        this.errors[name] = `${name} field must be a numeric value.`;
                                        isValid = false;
                                    }
                                });
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <template x-for="(name, index) in loadAggregate">
                                        <div class="mb-3">
                                            <label for="" class="form-label" x-text="name"></label>
                                            <input type="text" class="form-control" x-model="data[name]"
                                                @input="updateData(name, $event.target.value)">
                                            <p x-text="errors[name]" class="text-danger"></p>
                                        </div>
                                    </template>
                                </div>
                                ...
                                <div class="d-grid justify-content-center">
                                    ...
                                    <button class="btn btn-success btn-lg" type="button" @click="sendData()">
                                        Submit
                                    </button>
                                </div>
                            </div>
