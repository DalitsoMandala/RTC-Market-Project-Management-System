<div>
    @section('title')
        Upload Attendance Register Data
    @endsection
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                ...
                <h3 class="mb-5 text-center text-warning">ATTENDANCE REGISTER FORM</h3>
                ...
                <div
                    ...
                    <h5> Instructions</h5>
                    <p class="alert bg-secondary-subtle text-uppercase">Download the Attendance Register template &
                        upload
                        your
                        data.</p>
