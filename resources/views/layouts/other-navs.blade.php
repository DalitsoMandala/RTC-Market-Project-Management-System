          <header id="page-topbar" class="isvertical-topbar">
              <div class="navbar-header">
                  <div class="d-flex">
                      ...
                      <button type="button" class="px-3 btn btn-sm font-size-16 header-item vertical-menu-btn">
                      ...
                      <ul class="metismenu list-unstyled" id="side-menu">
                          ...
                          <li>
                              ...
                              <ul class="sub-menu" aria-expanded="false">
                                  ...
                                  <li><a href="ecommerce-add-product.html" data-key="t-add-product">Add Product</a>
                                  </li>
                              </ul>
                          </li>
                          ...
                          <li>
                              ...
                              <ul class="sub-menu" aria-expanded="false">
                                  ...
                                  <li><a href="invoices-detail.html" data-key="t-invoice-detail">Invoice Detail</a>
                                  </li>
                              </ul>
                          </li>
                          ...
                          <li>
                              ...
                              <ul class="sub-menu" aria-expanded="false">
                                  ...
                                  <li><a href="form-advanced.html" data-key="t-advanced-plugins">Advanced Plugins</a>
                                  </li>
                          ...
                          <li>
                              ...
                              <ul class="sub-menu" aria-expanded="false">
                                  <li><a href="tables-basic.html" data-key="t-bootstrap-basic">Bootstrap Basic</a>
                                  </li>
