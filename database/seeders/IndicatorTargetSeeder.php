...
class IndicatorTargetSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $year1 = [
            ...
            'Number of RTC POs selling products through aggregation centers aggregation center' => ['Total' => 3, 'type' => 'number'],
        ...
        $year2 = [
            ...
            'Number of POs that have formal contracts with buyers' => ['Total' => 5, 'type' => 'number'],
            'Number of RTC aggregation centers established' => ['Total' => 1, 'type' => 'number'],
            'Number of RTC POs selling products through aggregation centers aggregation center' => ['Total' => 7, 'type' => 'number'],
        ...
        $year3 = [
            ...
            'Number of RTC POs selling products through aggregation centers aggregation center' => ['Total' => 10, 'type' => 'number'],
        ...
        $year4 = [
            ...
            'Number of RTC POs selling products through aggregation centers aggregation center' => ['Total' => 20, 'type' => 'number'],
            'Volume (MT) of RTC products sold through collective marketing efforts by POs' => ['Total' => '8000', 'type' => 'number'],
