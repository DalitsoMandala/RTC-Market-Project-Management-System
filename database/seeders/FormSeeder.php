...
class FormSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $indicatorMappings = [
            ...
            $indicators['Number of private sector actors involved in production of RTC certified seed'] => ['REPORT FORM'],
            ...
            $indicators['Number of registered seed producers accessing markets through online Market Information System (MIS)'] => ['REPORT FORM'],
            ...
            $indicators['Number of RTC actors that use certified seed'] => ['REPORT FORM'],
            $indicators['Number of individuals trained in RTC related topics (seed multiplication, production, processing, entrepreneurship etc.)'] => ['REPORT FORM'],
            ...
            $indicators['Percentage increase in irrigated off-season RTC production by POs and commercial farmers (from baseline)'] => ['REPORT FORM'],
            ...
            $indicators['Number of POs that have formal contracts with buyers'] => ['RTC PRODUCTION AND MARKETING FORM FARMERS'],
            $indicators['Number of RTC aggregation centers established'] => ['REPORT FORM'],
            $indicators['Number of RTC POs selling products through aggregation centers'] => ['RTC PRODUCTION AND MARKETING FORM FARMERS'],
            $indicators['Volume (MT) of RTC products sold through collective marketing efforts by POs'] => ['RTC PRODUCTION AND MARKETING FORM FARMERS'],
            ...
            $indicators['Number of RTC actors with MBS certification for producing (or processing) RTC products'] => ['RTC PRODUCTION AND MARKETING FORM PROCESSORS'],
