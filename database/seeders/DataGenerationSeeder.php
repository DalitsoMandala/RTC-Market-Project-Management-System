        ...
        function rpmf()
        {
            ...
            return [
                'main' => [
                    ...
                    'number_of_plantlets_produced_cassava' => $faker->numberBetween(1000, 5000), // Random number for plantlets produced (cassava)
                    'number_of_plantlets_produced_potato' => $faker->numberBetween(1000, 5000), // Random number for plantlets produced (potato)
                    'number_of_plantlets_produced_sweet_potato' => $faker->numberBetween(1000, 5000), // Random number for plantlets produced (sweet potato)
                    'number_of_screen_house_vines_harvested' => $faker->numberBetween(100, 500), // Random number for vines harvested
                    'number_of_screen_house_min_tubers_harvested' => $faker->numberBetween(100, 500), // Random number for tubers harvested
                    'number_of_sah_plants_produced' => $faker->numberBetween(1000, 5000), // Random number for SAH plants produced
                    ...
                    'total_vol_production_previous_season' => $faker->numberBetween(1000, 10000), // Random volume for production (metric tonnes)
                    'prod_value_previous_season_total' => $faker->randomFloat(2, 10000, 50000), // Random float for total production value
                    ...
                    'prod_value_previous_season_usd_value' => $faker->randomFloat(2, 10000, 50000), // Random USD value
                    'total_vol_irrigation_production_previous_season' => $faker->numberBetween(500, 5000), // Random volume for irrigation production
                    'irr_prod_value_previous_season_total' => $faker->randomFloat(2, 5000, 30000), // Random total value for irrigation production
                    ...
                    'irr_prod_value_previous_season_usd_value' => $faker->randomFloat(2, 5000, 30000), // Random USD value for irrigation
                    ...
                    'total_vol_aggregation_center_sales' => $faker->numberBetween(500, 5000), // Random volume for aggregation center sales
                    'emp_formal_female_18_35' => $faker->numberBetween(10, 100), // Random number for formal female employees 18-35
                    'emp_formal_male_18_35' => $faker->numberBetween(10, 100), // Random number for formal male employees 18-35
                    'emp_formal_male_35_plus' => $faker->numberBetween(10, 100), // Random number for formal male employees 35+
                    'emp_formal_female_35_plus' => $faker->numberBetween(10, 100), // Random number for formal female employees 35+
                    'emp_informal_female_18_35' => $faker->numberBetween(10, 100), // Random number for informal female employees 18-35
                    'emp_informal_male_18_35' => $faker->numberBetween(10, 100), // Random number for informal male employees 18-35
                    'emp_informal_male_35_plus' => $faker->numberBetween(10, 100), // Random number for informal male employees 35+
                    'emp_informal_female_35_plus' => $faker->numberBetween(10, 100), // Random number for informal female employees 35+
                    'mem_female_18_35' => $faker->numberBetween(10, 100), // Random number for female members 18-35
                    'mem_male_18_35' => $faker->numberBetween(10, 100), // Random number for male members 18-35
                    'mem_male_35_plus' => $faker->numberBetween(10, 100), // Random number for male members 35+
                    'mem_female_35_plus' => $faker->numberBetween(10, 100), // Random number for female members 35+
                ],
                ...
                'conc_aggrement' => [
                    ...
                    'volume_sold_previous_period' => $faker->numberBetween(100, 1000), // Random volume sold
                    'financial_value_of_sales' => $faker->randomFloat(2, 1000, 10000), // Random financial value of sales
                    ...$dates
                ],
